...
/**
 * @description: 优先队列
 * 使用完全二叉堆排序元素的 PriorityQueue（优先队列）
 * @author: Created by yijq
 * @date: 2023/8/13 23:16
 */
public class PriorityQueue<E> implements Queue<E> {
    ...
    private void grow(int minCapacity) {
        ...
        // Double size(oldCapacity + 2) if small; else grow by 50%(oldCapacity >> 1)
    ...
    private void siftDownComparable(int k, E x) {
        ...
        while (k < half) {
            ...
            // 目标值与c比较，当目标值小于c值，退出循环，说明此时目标值所在位置合适，迁移完成。
